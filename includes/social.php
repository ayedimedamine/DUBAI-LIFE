	 ...
	 <!-- FACEBOOK  -->
	   <a class="text-white text-xl" href="https://www.facebook.com/sharer/sharer.php?u=https://gfycat.com/difficultpoisedamericanpainthorse&quote=J’ai pris mon ticket pour Dubaï ! Participes toi aussi au plus grand jeu concours ! https://www.the-new-life.fr"  target="_blank">
		...
		<a class="text-white text-xl hover:cursor-pointer" target="_blank" >
		    <div class="rounded-md py-2 sm:py-3 flex px-2 sm:px-6 items-center justify-center bg-[#5c73f5] hover:shadow-md transition-all st-custom-button" data-network="sms" data-url="J’ai pris mon ticket pour Dubaï ! Participes toi aussi au plus grand jeu concours @the-new-life,fr https://gfycat.com/difficultpoisedamericanpainthorse">
